...
/**
 * Stores the amount of miles flown on a given airline for the customer 
...
public class Miles implements Comparable<Object> {
	...
	public int compareTo(Object o) {
		if (this.totalMiles < ((Miles)o).getTotalMiles()) {
			return -1;
		} else if (this.totalMiles > ((Miles)o).getTotalMiles()) {
			return 1;
		} else {
			return 0;
		}
