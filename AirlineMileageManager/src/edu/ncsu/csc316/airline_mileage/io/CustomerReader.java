...
/**
 * This class contains static methods which allow for the reading of customer data files.
...
public class CustomerReader {
	 ...
	 */
	public static ArrayList<Customer> readCustomerRecords(String file, ArrayList<Flight> flights) throws FileNotFoundException {
		...
		while (fileReader.hasNextLine()) {
			...
			flight.setDistance(flights.get(index).getDistance());
