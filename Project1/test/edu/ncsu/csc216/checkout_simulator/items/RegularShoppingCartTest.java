...
public class RegularShoppingCartTest {
	...
	/**
	 * Test method for {@link edu.ncsu.csc216.checkout_simulator.items.RegularShoppingCart#getInLine(edu.ncsu.csc216.checkout_simulator.queues.CheckoutRegister[])}.
	 */
	@Test
	public void testGetInLine() {
		RegularShoppingCart c = new RegularShoppingCart(0, 0);
	...
	/**
	 * Test method for {@link edu.ncsu.csc216.checkout_simulator.items.RegularShoppingCart#getColor()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link edu.ncsu.csc216.checkout_simulator.items.RegularShoppingCart#RegularShoppingCart(int, int)}.
	 */
	@SuppressWarnings("unused")
	@Test
	public void testRegularShoppingCart() {
		try {
			RegularShoppingCart c = new RegularShoppingCart(-1, 0);
		...
		try {
			RegularShoppingCart d = new RegularShoppingCart(0, -1);
	...
	public void testGetArrivalTime() {
		RegularShoppingCart c = new RegularShoppingCart(40, 0);
	...
	public void testGetProcessTime() {
		RegularShoppingCart c = new RegularShoppingCart(0, 40);
