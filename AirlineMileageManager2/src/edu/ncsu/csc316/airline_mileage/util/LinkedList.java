...
/**
 * The linked list data structure used in P1P2 of CSC316. (From Project 1)
 * @author Walker Booth
 *
...
public class LinkedList<E> implements List<E> {
	...
	/**
	 * Returns an element from a specified index of the Linked List
	 * @param index the index to retrieve from 
	 * @return current.data the data at the requested index 
	 */
