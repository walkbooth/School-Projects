...
/**
 * Tests the CustomerReader class (From Project 1) 
...
public class CustomerReaderTest {
	...
	public void testReadCustomerRecords() {
		...
		HashTable<Flight> flightsOnFile = null;
		...
		try {
			...
			try {
				ArrayList<Flight> flightsOnFileList = FlightReader.readFlightRecords(validFlightsFile);
				flightsOnFile = new HashTable<Flight> (flightsOnFileList.size());
				for (int i = 0; i < flightsOnFileList.size(); i++) {
					flightsOnFile.add(flightsOnFileList.get(i));
				}
