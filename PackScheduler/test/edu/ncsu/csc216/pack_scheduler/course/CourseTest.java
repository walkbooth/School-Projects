...
public class CourseTest {
	...
	public void testSetSection() {
		...
		//Test that setting the section to "1" doesn't change the section (or anything else).
				try {
					c.setSection("1");
					fail();
				} catch (IllegalArgumentException e) {
		...
		// Tries to set it to a string that contains a letter, tests to see that nothing is changed
		try {
			c.setSection("0A0");
			fail();
		} catch (IllegalArgumentException e) {
	...
	public void testSetCredits() {
		...
		//Test that setting the credits to -1 doesn't change the credits (or anything else).
		try {
			c.setCredits(-1);
			fail();
		} catch (IllegalArgumentException e) {
		...
		//Test that setting the credits to 7 doesn't change the credits (or anything else).
		try {
			c.setCredits(7);
			fail();
		} catch (IllegalArgumentException e) {
	...
	public void testSetInstructorId() {
		...
		//Valid set, win$t0nchurch4i11
		c.setInstructorId("win$t0nchurch4i11");
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
		assertEquals("win$t0nchurch4i11", c.getInstructorId());
		assertEquals(MEETING_DAYS, c.getMeetingDays());
		assertEquals(START_TIME, c.getStartTime());
		assertEquals(END_TIME, c.getEndTime());
	...
	public void testSetMeetingDays() {
		...
		//Valid set, duplicate, MMWF
		c.setMeetingDays("MMWF");
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
		assertEquals(INSTRUCTOR_ID, c.getInstructorId());
		assertEquals("MMWF", c.getMeetingDays());
		assertEquals(START_TIME, c.getStartTime());
		assertEquals(END_TIME, c.getEndTime());
		
		//Valid set, backwards, FWM
		c.setMeetingDays("FWM");
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
		assertEquals(INSTRUCTOR_ID, c.getInstructorId());
		assertEquals("FWM", c.getMeetingDays());
		assertEquals(START_TIME, c.getStartTime());
		assertEquals(END_TIME, c.getEndTime());		
	...
	public void testGetMeetingString() {
		...
		Activity c6 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "M", 0, 100);
		assertEquals("M 12:00AM-1:00AM", c6.getMeetingString());
		Activity c7 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "MWF", 1130, 1230);
		assertEquals("MWF 11:30AM-12:30PM", c7.getMeetingString());
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "MW", 1100, 1200);
		assertEquals("MW 11:00AM-12:00PM", c8.getMeetingString());
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "MTWHF", 2000, 2100);
		assertEquals("MTWHF 8:00PM-9:00PM", c9.getMeetingString());
		Activity c10 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "WF", 123, 247);
		assertEquals("WF 1:23AM-2:47AM", c10.getMeetingString());
		Activity c11 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "WF", 1312, 1356);
		assertEquals("WF 1:12PM-1:56PM", c11.getMeetingString());
		Activity c12 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "MWH", 2259, 2359);
		assertEquals("MWH 10:59PM-11:59PM", c12.getMeetingString());
	}
	...
	public void testEqualsObject() {
		...
		Activity c3a = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3b = new Course(NAME, "different", SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c4a = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c4b = new Course(NAME, TITLE, "001", CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5a = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5b = new Course(NAME, TITLE, SECTION, 4, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6a = new Course(NAME, TITLE, SECTION, CREDITS, "Different", CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6b = new Course(NAME, TITLE, SECTION, CREDITS, "DifferenT", CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c7a = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "TH", START_TIME, END_TIME);
		Activity c7b = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, "TW", START_TIME, END_TIME);
		Activity c8a = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, 830, END_TIME);
		Activity c8b = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, 831, END_TIME);
		Activity c9a = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, 1401);
		Activity c9b = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, 1400);
		...
		assertFalse(c1.equals(c3a));
		assertFalse(c1.equals(c4a));
		assertFalse(c1.equals(c5a));
		assertFalse(c1.equals(c6a));
		assertFalse(c1.equals(c7a));
		assertFalse(c1.equals(c8a));
		assertFalse(c1.equals(c9a));
		
		assertFalse(c2.equals(c3a));
		assertFalse(c2.equals(c4a));
		assertFalse(c2.equals(c5a));
		assertFalse(c2.equals(c6a));
		assertFalse(c2.equals(c7a));
		assertFalse(c2.equals(c8a));
		assertFalse(c2.equals(c9a));
		
		// Try similar but sightly different variables
		assertFalse(c3a.equals(c3b));
		assertFalse(c4a.equals(c4b));
		assertFalse(c5a.equals(c5b));
		assertFalse(c6a.equals(c6b));
		assertFalse(c7a.equals(c7b));
		assertFalse(c8a.equals(c8b));
		assertFalse(c9a.equals(c9b));
	}
	...
	public void testHashCode() {
		...
		assertEquals(c4.hashCode(), c4a.hashCode());
		assertEquals(c5.hashCode(), c5a.hashCode());
		...
		assertNotEquals(c3.hashCode(), c6.hashCode());
		assertNotEquals(c3.hashCode(), c7.hashCode());
		assertNotEquals(c3.hashCode(), c8.hashCode());
		assertNotEquals(c3.hashCode(), c9.hashCode());
		
		assertNotEquals(c4.hashCode(), c5.hashCode());
		assertNotEquals(c4.hashCode(), c6.hashCode());
		assertNotEquals(c4.hashCode(), c7.hashCode());
		assertNotEquals(c4.hashCode(), c8.hashCode());
		assertNotEquals(c4.hashCode(), c9.hashCode());

		assertNotEquals(c5.hashCode(), c6.hashCode());
		assertNotEquals(c5.hashCode(), c7.hashCode());
		assertNotEquals(c5.hashCode(), c8.hashCode());
		assertNotEquals(c5.hashCode(), c9.hashCode());

		assertNotEquals(c6.hashCode(), c7.hashCode());
		assertNotEquals(c6.hashCode(), c8.hashCode());
		assertNotEquals(c6.hashCode(), c9.hashCode());

		assertNotEquals(c7.hashCode(), c8.hashCode());
		assertNotEquals(c7.hashCode(), c9.hashCode());
	...
	public void testToString() {
		...
		Activity c3 = new Course("MA305", "Introduction to Linear Algebra", SECTION, CREDITS, INSTRUCTOR_ID, CAP, "TH", 0, 100);
		String s3 = "MA305,Introduction to Linear Algebra,001,4,sesmith5,20,TH,0,100";
