...
/**
 * Tests the class CourseNameValidatorFSM. CourseNameValidatorFSM has a switch based FSM.
 * @author Alex Johnson
 * @author James Ritchey
 * @author Connor McCarthy 
 */
public class CourseNameValidatorFSMTest {
	/** The CourseNameValidatorFSM object used for testing */
	private CourseNameValidatorFSM fsm;
	
	/**
	 * Sets up the CourseNameValidatorFSM tests.
	 * @throws Exception if there's any error initializing CourseNameValidatorFSMTest
	 */
	@Before
	...
	/**
	 * Tests the initial state of the CourseNameValidatorFSM
	 */
	@Test
	...
	/**
	 * Tests the LetterState of the CourseNameValidatorFSM
	 */
	@Test
	...
	/**
	 * Test the digit state of the CourseNameValidatorFSM
	 */
	@Test
	...
	/**
	 * Tests the suffix state of CourseNameValidatorFSM
	 */
	@Test
