...
public class FacultyScheduleTest {
	...
	public void testAddCourseToSchedule() {
		...
		Course csc116 = catalog.getCourseFromCatalog("CSC116", "001");
		...
		//Add a third course
		Course csc116002 = catalog.getCourseFromCatalog("CSC116", "002");
		csc116002.setInstructorId(null);
		schedule.addCourseToSchedule(csc116002);
	...
	public void testResetSchedule() {
		...
		Course csc230 = catalog.getCourseFromCatalog("CSC230", "001");
		csc230.setInstructorId(null);
		
		//Check that resetting doesn't break future adds
		schedule.addCourseToSchedule(csc230);
