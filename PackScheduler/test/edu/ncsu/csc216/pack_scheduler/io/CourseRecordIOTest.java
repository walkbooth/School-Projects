...
public class CourseRecordIOTest {
	...
	/**
	 * Tests if a CourseRecordIO can be constructed
	 */
	@Test
	public void testNoConstruction () {
		
		CourseRecordIO c = null;
		try {
			c = new CourseRecordIO();
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals("This class should not be constructed.", e.getMessage());
			assertNull(c);
		}
