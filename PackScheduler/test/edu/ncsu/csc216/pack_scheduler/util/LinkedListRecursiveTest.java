...
public class LinkedListRecursiveTest {
	...
	/**
	 * Tests construction of an LinkedListRecursive
	 */
	@Test
	public void testNewLinkedListRecursive () {

		// Test making an ArrayList of BigInteger
		LinkedListRecursive<BigInteger> httpStatusCodes = new LinkedListRecursive<BigInteger>();
		...
		LinkedListRecursive<String> httpStatus = new LinkedListRecursive<String>();
		...
		LinkedListRecursive<HashMap<String, Color>> palettes  = new LinkedListRecursive<HashMap<String, Color>>();
	...
	public void testAdd () {
		...
		// Test adding String
		LinkedListRecursive<String> httpHeader = new LinkedListRecursive<String>();
		...
		//Resets httpHeader
		httpHeader = new LinkedListRecursive<String>();
	...
	/**
	 * Tests method removeIdx of class ArrayList
	 */
	@Test
	public void testRemoveIdx () {
		...
		assertFalse(httpHeader.remove(null));
		
	}
	
	/**
	 * Tests method removeE of class ArrayList
	 */
	@Test
	public void testRemoveE () {
		...
		assertFalse(httpHeader.remove("HTTP/1.1 200 OK"));
		...
		assertTrue(httpHeader.remove("HTTP/1.1 403 FORBIDDEN"));
		assertEquals(3, httpHeader.size());
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(1));
		assertEquals("HTTP/1.1 500 INTERNAL SERVER ERROR", httpHeader.get(2));

		assertTrue(httpHeader.remove("HTTP/1.1 500 INTERNAL SERVER ERROR"));
		assertEquals(2, httpHeader.size());
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(1));
		
		assertTrue(httpHeader.remove("HTTP/1.1 200 OK"));
		assertEquals(1, httpHeader.size());
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(0));
		
		assertTrue(httpHeader.remove("HTTP/1.1 404 NOT FOUND"));
		assertEquals(0, httpHeader.size());
	}
	...
	public void testGet () {
		...
		LinkedListRecursive<String> request = new LinkedListRecursive<String>();
	...
	public void testSet () {
		...
		assertEquals("HTTP/1.1 403 FORBIDDEN", httpHeader.set(0, "HTTP/1.1 200 OK"));
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(1));
		assertEquals("HTTP/1.1 500 INTERNAL SERVER ERROR", httpHeader.get(2));
		assertEquals("HTTP/1.1 301 REDIRECT", httpHeader.get(3));

		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.set(1, "HTTP/1.1 403 FORBIDDEN"));
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 403 FORBIDDEN", httpHeader.get(1));
		assertEquals("HTTP/1.1 500 INTERNAL SERVER ERROR", httpHeader.get(2));
		assertEquals("HTTP/1.1 301 REDIRECT", httpHeader.get(3));

		assertEquals("HTTP/1.1 500 INTERNAL SERVER ERROR", httpHeader.set(2, "HTTP/1.1 404 NOT FOUND"));
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 403 FORBIDDEN", httpHeader.get(1));
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(2));
		assertEquals("HTTP/1.1 301 REDIRECT", httpHeader.get(3));

		assertEquals("HTTP/1.1 301 REDIRECT", httpHeader.set(3, "HTTP/1.1 500 INTERNAL SERVER ERROR"));
		assertEquals("HTTP/1.1 200 OK", httpHeader.get(0));
		assertEquals("HTTP/1.1 403 FORBIDDEN", httpHeader.get(1));
		assertEquals("HTTP/1.1 404 NOT FOUND", httpHeader.get(2));
		assertEquals("HTTP/1.1 500 INTERNAL SERVER ERROR", httpHeader.get(3));
	...
	public void testSize () {
		...
		LinkedListRecursive<String> queries = new LinkedListRecursive<String>();
