...
public class ArrayStackTest {
	...
	/**
	 * Test the construction of an ArrayStack
	 */
	@Test
	public void testNewArrayStack () {
		
		// Test making an ArrayList of BigInteger
		Stack<BigInteger> httpStatusCodes = new ArrayStack<BigInteger>(3);
		...
		Stack<String> httpStatus = new ArrayStack<String>(3);
		...
		Stack<HashMap<String, Color>> palettes  = new ArrayStack<HashMap<String, Color>>(3);
	...
	/**
	 * Tests method push of class ArrayStack
	 */
	@Test
	public void testPush () {
		// Test pushing String
		Stack<String> httpHeader = new ArrayStack<String>(5);
		...
		//Resets httpHeader
		httpHeader = new ArrayStack<String>(10);
	...
	/**
	 * Tests the pop method of ArrayStack 
	 */
	@Test
	public void testPop () {
		
		Stack<String> httpHeader = new ArrayStack<String>(10);
		try {
			httpHeader.pop();
	...
	/**
	 * Tests methods isEmpty and size in class ArrayStack
	 */
	@Test
	...
	/**
	 * Tests method setCapacity of class ArrayStack
	 */
	@Test
