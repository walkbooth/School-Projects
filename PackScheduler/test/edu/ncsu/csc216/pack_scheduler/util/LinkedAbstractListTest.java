...
public class LinkedAbstractListTest {
	...
	/**
	 * Tests construction of an LinkedAbstractList
	 */
	@Test
	public void testNewLinkedAbstractList () {

		// Test making an ArrayList of BigInteger
		LinkedAbstractList<BigInteger> httpStatusCodes = new LinkedAbstractList<BigInteger>(4);
		...
		LinkedAbstractList<String> httpStatus = new LinkedAbstractList<String>(4);
		...
		LinkedAbstractList<HashMap<String, Color>> palettes  = new LinkedAbstractList<HashMap<String, Color>>(4);
	...
	public void testAdd () {
		...
		// Test adding String
		LinkedAbstractList<String> httpHeader = new LinkedAbstractList<String>(100);
		...
		//Resets httpHeader
		httpHeader = new LinkedAbstractList<String>(100);
	...
	public void testGet () {
		...
		LinkedAbstractList<String> request = new LinkedAbstractList<String>(100);
	...
	public void testSize () {
		...
		LinkedAbstractList<String> queries = new LinkedAbstractList<String>(100);
	...
	/**
	 * Tests method setCapacity of class LinkedAbstractList
	 */
	@Test
	public void testSetCapacity () {
		LinkedAbstractList<String> httpHeader = new LinkedAbstractList<String>(2);
